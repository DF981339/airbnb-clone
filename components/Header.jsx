...
function Header() {
  return (
    <header>
      {/* Desktop View */}
      <div className="sticky top-0 z-50 bg-white shadow-md h-20 px-10 logo-bp:px-20 hidden mobile-view:flex">
        {/* Left Side */}
        <div className="flex search-bar-bp:flex-grow items-center h-full">
          {/* Long Logo */}
          <div className="hidden flex-header logo-bp:inline-flex">
            <svg
              width={102}
              height={32}
              fill="#FF385C"
        ...
        {/* Middle - Search Bar */}
        <div className="flex flex-shrink-0 justify-center items-center h-full mx-6 w-search_bar_min_width">
      ...
      {/* Mobile View */}
      <div className="sticky top-0 z-50 flex bg-white shadow-md h-20 px-6 mobile-view:hidden">
